            ...
            <View style={styles.formOne}>
              <View style={styles.formHeader}>
                    ...
                    {formTwoView && (
                      <View style={styles.hiddenContent}>
                        <View style={styles.hiddenElement}>
                          <View>
                            <Text style={styles.hiddenElementText}>
                              ISSUE DATE *
                            </Text>
                ...
                <View style={styles.formOneHeader}>
                  <Text style={styles.formOneHeaderText}>CREATE A DEAL</Text>
                </View>
              </View>
              ...
              <View style={styles.formItemsOne}>
                ...
                <View style={styles.formOneItems}>
                  <View style={styles.formOneLabel}>
                    <Text style={styles.formOneLabelText}>DATE *</Text>
                  </View>
              ...
              <View style={styles.formOneItemsButton}>
                <View style={styles.nextButtonContainer}>
                  <View
                    style={[styles.nextButton, {backgroundColor: '#3172D9'}]}>
                    <TouchableOpacity
                      onPress={() => butttonTwo()}
          ...
          {stepTwo && (
            <View style={styles.formOne}>
              ...
              <View style={styles.formItemsTwo}>
                ...
                <View style={styles.formOneItems}>
                  <View style={styles.formOneLabel}>
                    <Text style={styles.formOneLabelText}>ISSUE DATE *</Text>
                  </View>
                  <View style={styles.formOneInputDate}>
                    <DatePicker
                      style={{width: '100%'}}
